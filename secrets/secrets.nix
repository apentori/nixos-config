...
let
  ...
  hermes = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFLLh2IBJaK6GaGtUDBZKnGpIgR54QKAnpGV1B/aMFfq root@hermes";
...
in
{
  ...
  "services/habitsync/basic-auth.age" = { publicKeys = [ irotnep hyperion mnemosyme hermes ]; };
